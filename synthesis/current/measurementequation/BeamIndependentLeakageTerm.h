...
#ifndef BEAM_INDEPENDENT_LEAKAGE_TERM_H
...
struct BeamIndependentLeakageTerm : public ParameterizedMEComponent<false> {
   
   /// @brief constructor, store reference to paramters
   /// @param[in] par shared pointer to parameters
   inline explicit BeamIndependentLeakageTerm(const scimath::Params::ShPtr &par) : 
