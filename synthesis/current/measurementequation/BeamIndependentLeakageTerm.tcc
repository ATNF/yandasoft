...
#ifndef BEAM_INDEPENDENT_LEAKAGE_TERM_TCC
...
/// this effect
inline scimath::ComplexDiffMatrix BeamIndependentLeakageTerm::get(const accessors::IConstDataAccessor &chunk, 
                                      casa::uInt row) const
{
   ...
   calFactor(3, 1) = -1.*getParameter(accessors::CalParamNameHelper::paramName(ant1, 0, casa::Stokes::YX));
   calFactor(1, 3) = getParameter(accessors::CalParamNameHelper::paramName(ant1, 0, casa::Stokes::XY));
   
   calFactor(3, 2) = -1.*conj(getParameter(accessors::CalParamNameHelper::paramName(ant2, 0, casa::Stokes::YX)));
   calFactor(2, 3) = conj(getParameter(accessors::CalParamNameHelper::paramName(ant2, 0, casa::Stokes::XY)));
   ...
   for (casa::uInt pol=0; pol<4; ++pol) {
        ...
        calFactor(pol, 3 - pol) = (pol % 3 == 0 ? 1. : -1.)*getParameter(accessors::CalParamNameHelper::paramName(ant1, 
                            0, pol < 2 ? casa::Stokes::XY : casa::Stokes::YX))*
                            conj(getParameter(accessors::CalParamNameHelper::paramName(ant2, 0, 
...
#endif // #ifndef BEAM_INDEPENDENT_LEAKAGE_TERM_TCC
