...
protected:
   ...
   /// shapes
   void imageRegrid(const casacore::Array<imtype> &input, casacore::Array<imtype> &output,
                    bool toTarget, bool isWeights = false) const;

   void pcfRegrid(casacore::ImageRegrid<imtype>& regridder) const;
   ...
   void imageClip(casacore::Array<imtype> &img, const float factor) const;
...
private:
   ...
   /// coordinate frame
   casacore::Array<imtype> itsImageBuffer;

   /// @brief buffer for weights
   /// @details It accumulates weights during gridding
   casacore::Array<imtype> itsWeightsBuffer;
   ...
   mutable casacore::TempImage<imtype> itsTempInImg;

   /// @brief temporary output image for regridding
   mutable casacore::TempImage<imtype> itsTempOutImg;
