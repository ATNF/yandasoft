...
struct UVPattern {
   ...
   inline const casacore::Matrix<imtypeComplex>& pattern() const
   { return itsArray; }

   /// @brief read-write access to a pattern
   /// @details This method allows a direct access to the pattern array
   /// @return non-const reference to the pattern
   inline casacore::Matrix<imtypeComplex>& pattern()
   { return itsArray; }
   ...
   inline const imtypeComplex& operator()(casacore::uInt iu, casacore::uInt iv) const
   ...
   inline imtypeComplex& operator()(casacore::uInt iu, casacore::uInt iv)
   { return itsArray(iu,iv); }
...
private:
   ...
   casacore::Matrix<imtypeComplex> itsArray;
