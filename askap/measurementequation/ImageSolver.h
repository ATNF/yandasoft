...
namespace synthesis
{
    ...
    public:
        ...
        /// @details
        /// @param[in] psf point spread function to modify
        ...
        float doNormalization(const casacore::Vector<imtype>& diag,
        ...
        /// mask-related functionality. Hint: use utility::NullDeleter to wrap a shared pointer
        /// over an existing array reference.
        inline float doNormalization(const casacore::Vector<imtype>& diag,
