...
#ifndef PRE_AVG_DDCAL_ME_BASE_H
#define PRE_AVG_DDCAL_ME_BASE_H
...
class PreAvgDDCalMEBase : public scimath::GenericEquation 
{
public:
  /// @brief constructor setting up only parameters
  /// @param[in] ip Parameters
  PreAvgDDCalMEBase(const askap::scimath::Params& ip);
...
#endif // #ifndef PRE_AVG_DDCAL_ME_BASE_H
