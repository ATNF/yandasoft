...
public:
   ...
   /// @brief w-term without snap-shotting that is larger than given percentile of w's
   /// @return absolute value of p percentile w in wavelengths
   double wPercentile() const { return itsWPercentileCalculator.value(); };
