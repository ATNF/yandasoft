...
clean_and_uninstall() {
	...
	if [  -d `repo2dir $1` ]; then
		...
		echo "Directory " `repo2dir $1` " not found"
	fi
	cd "$startdir"
}
source_venv() {
...
if [ $clean_dependencies == yes ]; then
	
	clean_and_uninstall https://github.com/casacore/casacore 
	clean_and_uninstall https://github.com/casacore/casarest 
