...
namespace askap
{
  namespace synthesis
  {
    ...
    public:
        void testCopy()
        {
          casacore::Matrix<casacore::Double> in(2,2,1.);
          std::vector<double> vec(2,3.);
          vec[0]=-3.;
          copyVector(vec,in.row(0));
          CPPUNIT_ASSERT(fabs(in(0,0)+3.)<1e-10 && fabs(in(0,1)-3.)<1e-10);
          casacore::Vector<casacore::Complex> complexVec(1,casacore::Complex(-1.,-2.));
          copyVector(complexVec,in.row(1));
          CPPUNIT_ASSERT(fabs(in(1,0)+1.)<1e-10 && fabs(in(1,1)+2.)<1e-10);
          std::vector<casacore::AutoDiff<double> > autoDiffVec(2, 
                                          casacore::AutoDiff<double>(0.,1));
          autoDiffVec[0]=sin(casacore::AutoDiff<double>(0.,1,0));
          autoDiffVec[1]=1.+cos(casacore::AutoDiff<double>(casacore::C::_2pi/4.,1,0));
          ...
          std::vector<scimath::ComplexDiff> complexDiffVec(1,
                        scimath::ComplexDiff("par1",casacore::Complex(0.,-1.)));
          complexDiffVec[0] *= scimath::ComplexDiff("par2", casacore::Complex(2.,0.));
        ...
        void testAddScaled()
        {
          ...
          addScaledVector(vec, complexVec, casacore::Complex(-1., 2.));
        ...
        void test1()
        {
          std::vector<casacore::AutoDiff<casacore::Complex> > autoDiffVec(2, 
                                          casacore::AutoDiff<casacore::Complex>(casacore::Complex(0.,0.),1));
          autoDiffVec[0]=sin(casacore::AutoDiff<casacore::Complex>(0.,1,0))+casacore::Complex(0,1.)*cos(casacore::AutoDiff<casacore::Complex>(0.,1,0));
          //autoDiffVec[1]=casacore::Complex(1.)+cos(casacore::AutoDiff<casacore::Complex>(casacore::C::_2pi/4.,1,0));
          autoDiffVec[1]=exp(casacore::AutoDiff<casacore::Complex>(casacore::C::_2pi/4.,1,0)*casacore::Complex(0,1.));
